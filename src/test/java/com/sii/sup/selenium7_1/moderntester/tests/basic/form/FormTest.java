package com.sii.sup.selenium7_1.moderntester.tests.basic.form;

import com.sii.sup.selenium7_1.moderntester.tests.base.TestBase;
import com.sii.sup.selenium7_1.moderntester.utils.Helper;
import com.sii.sup.selenium7_1.moderntester.pageobject.FormPage;
import com.sii.sup.selenium7_1.moderntester.pageobject.Gender;
import com.sii.sup.selenium7_1.moderntester.pageobject.HomePage;
import com.sii.sup.selenium7_1.moderntester.pageobject.TesterProfession;
import com.sii.sup.selenium7_1.moderntester.pageobject.navbar.NavbarButtons;
...
public class FormTest extends TestBase {
    ...
    private static String createTempFileInFormResources() {
        ...
        try {
            URL formResourcesUrl = FormTest.class.getClassLoader().getResource("FormTest/");
    ...
    @ParameterizedTest
    @MethodSource("com.sii.sup.selenium7_1.moderntester.tests.data.DataSource#formTestDataSource")
